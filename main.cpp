...
//declare global variable for input charachter
char inp_char = 0;
...
int main() {
    ...
    print_distance();
    printf("\r\n");
    printf("Please use one of the following keys to get specific data: \r\n t - temperatur,\r\n m - magnus,\r\n a - accelerometer,\r\n g - gyro,\r\n d - distance \r\n\n");
    
    pc.attach(&pc_interrupt);

    while(1) {

        //act on different charachter input
        switch(inp_char){
            case 't':
                print_t_rh();
                //reset input charachter back to 0
                inp_char = 0;
                break;
            case 'm':
                print_mag();
